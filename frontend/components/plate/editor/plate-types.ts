...
import { ELEMENT_EXCALIDRAW, type TExcalidrawElement } from '@udecode/plate-excalidraw';
import {
  ELEMENT_H1,
  ELEMENT_H2,
  ELEMENT_H3,
...
import { ELEMENT_LINK, type TLinkElement } from '@udecode/plate-link';
import {
  ELEMENT_LI,
  ELEMENT_OL,
  ELEMENT_TODO_LI,
...
import { ELEMENT_TABLE, ELEMENT_TD, ELEMENT_TR, type TTableElement } from '@udecode/plate-table';
