...
export default async function Page() {
  ...
  const PageFromTheme: LazyExoticComponent<(props: ForumsForumViewProps) => JSX.Element> = lazy(
    () =>
      import(`@/themes/${theme_id}/forum/views/forum/forums/forums-forum-view`).catch(
