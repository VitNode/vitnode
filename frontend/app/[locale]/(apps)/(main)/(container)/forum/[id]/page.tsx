...
export default async function Page({ params: { id } }: Props) {
  ...
  const PageFromTheme: LazyExoticComponent<(props: ForumForumViewProps) => JSX.Element> = lazy(() =>
    import(`@/themes/${theme_id}/forum/views/forum/forums/views/[id]/forum-forum-view`).catch(
      () => import('@/themes/1/forum/views/forum/forums/views/[id]/forum-forum-view')
    )
  );
