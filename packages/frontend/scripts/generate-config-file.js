...
const generateConfigFile = async () => {
    ...
    if (!fs.existsSync(configPath)) {
        ...
        console.log('\x1b[34m%s\x1b[0m', '[VitNode]', 'Config file created successfully.');
        process.exit(0);
    }
    console.log('\x1b[34m%s\x1b[0m', '[VitNode]', 'Config file already exists. Updating...');
    ...
    console.log('\x1b[34m%s\x1b[0m', '[VitNode]', 'Config file updated successfully.');
};
