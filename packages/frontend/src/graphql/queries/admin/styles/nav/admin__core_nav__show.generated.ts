...
export type Admin__Core_Nav__ShowQuery = { __typename?: 'Query', core_nav__show: { __typename?: 'ShowCoreNavObj', edges: Array<{ __typename?: 'ShowCoreNav', id: number, href: string, external: boolean, position: number, children: Array<{ __typename?: 'ShowCoreNavItem', id: number, href: string, external: boolean, position: number, description: Array<{ __typename?: 'StringLanguage', language_code: string, value: string }>, name: Array<{ __typename?: 'StringLanguage', language_code: string, value: string }> }>, description: Array<{ __typename?: 'StringLanguage', language_code: string, value: string }>, name: Array<{ __typename?: 'StringLanguage', language_code: string, value: string }> }> } };
