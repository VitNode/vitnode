...
export type Admin__Core_Authorization_Settings__ShowQuery = { __typename?: 'Query', admin__core_authorization_settings__show: { __typename?: 'ShowAdminAuthorizationSettingsObj', force_login: boolean, lock_register: boolean, require_confirm_email: boolean } };
