...
Inside input DTO you can use `StringLanguageInput[]` for translation fields.
...
Inside object DTO you can use `StringLanguage` for translation fields.

```ts
import { Field, ObjectType } from '@nestjs/graphql';
import { StringLanguage } from 'vitnode-backend';
...
To create or edit translation fields you need to use `ParserStringLanguageCoreHelpersService` service. This service will help you to parse the translation fields.

```ts title="backend/plugins/blog/categories/edit/edit.service.ts"
import { Injectable } from '@nestjs/common';
import {
  NotFoundError,
  ParserStringLanguageCoreHelpersService,
} from 'vitnode-backend';
...
export class EditBlogCategoriesService {
  constructor(
    ...
    private parserTextLang: ParserStringLanguageCoreHelpersService,
  ) {}
...
To delete translation fields you need to use `ParserStringLanguageCoreHelpersService` service. This service will help you to delete the translation fields and remove sub-features like mentions, attachments, etc.
...
Instead of `StringLanguageInput` you can use `Editor` component. [Read more](/docs/ui/editor#form).
