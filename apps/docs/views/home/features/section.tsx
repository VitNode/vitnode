...
export const SectionFeatures = ({
  ...
  return (
    <div className="grid grid-cols-1 gap-y-8 gap-x-12 lg:grid-cols-2 lg:items-center xl:gap-x-20">
      <Image
        src={img}
      ...
      <div className={cn({ "order-2 lg:order-1": reverse })}>
        ...
        <p className="mt-2 text-base font-normal lg:text-lg text-muted-foreground">
          {desc}
        </p>
