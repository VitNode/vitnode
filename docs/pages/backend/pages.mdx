      ...
      <FileTree.Folder name="[locale]" defaultOpen>
        <FileTree.Folder name="(apps)" defaultOpen>
          <FileTree.Folder name="(main)" defaultOpen>
            <FileTree.Folder name="(container)" defaultOpen>
...
But if you don't want to have paddings and margins you can create a file `page.tsx` outside of `(container)` folder:
